...
class CompanyUserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $office3 = CompanyOffice::where('office_name', 'KORPHEAL - Tollygunge')->first();
        $office4 = CompanyOffice::where('office_name', 'KORPHEAL - Bosepukur')->first();
        ...
        CompanyUser::create([
            ...
            'company_office_id' => $office3->id,
            'is_primary'        => 0,
            'is_tester'         => 1,
            'name'              => 'Ravi Sharma',
            'email'             => 'digitalkadhya@gmail.com',
            'password'          => Hash::make('digitalkadhya123'),
            'phone'             => '9988776655',
            'role_id'           => 4,
            'designation'       => 'Admin',
            'status'            => 'active',
