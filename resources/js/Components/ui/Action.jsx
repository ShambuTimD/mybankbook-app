    ...
    return (
        <>
            <div className="relative inline-block text-left" ref={menuRef}>
                ...
                >
                    <div
                        className="absolute right-0 z-20 mt-2 min-w-[220px] max-w-[280px]
 origin-top-right bg-white dark:bg-gray-800 rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 dark:ring-white/10"
                        role="menu"
            ...
            >
                <div className="p-6 text-center">
                    ...
                    {/* Description */}
                    <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 max-w-xs mx-auto leading-relaxed">
